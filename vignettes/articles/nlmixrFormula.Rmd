...
## build.  Each `:=` target is its own cache entry, so the fits below are named
## rather than all reusing `mod`.  See vignettes/precompute.R.
options(nlmixr2save.dir = "../cache",
        nlmixr2save.prefix = "nlmixrFormula-",
