...
test_that(".iniDfMatchColumns() lets hand built rows rbind with either shape", {
  ...
  expect_equal(names(.nlmixr2extra$.iniDfMatchColumns(.extra, .iniDfNoPrior())), names(.iniDfNoPrior()))
  expect_error(rbind(.iniDfNoPrior(), .nlmixr2extra$.iniDfMatchColumns(.extra, .iniDfNoPrior())), NA)
})
